...
import { CalendarDays, ArrowRight, BookOpenText, ClipboardCheck } from 'lucide-react';

export default function WeeksPage(){
  const [rows,setRows]=useState<WeekSummary[]>([]);
  ...
  return <AuthGate><AppShell title="Minggu Pembelajaran">
    <div className="section-title"><div><span className="eyebrow">14 MINGGU • 28 MATERI</span><h2>Alur Pembelajaran</h2><p className="muted">Materi 1+2, 3+4, dan seterusnya tanpa mengubah urutan sumber.</p></div></div>
    ...
    {!rows.length&&!error&&<div className="screen-center small"><div className="spinner"/>Memuat minggu...</div>}
  </AppShell></AuthGate>
}
